...
// (same theme logic as your Hub.vue)
  ...
  switch (theme.value) {
    case 'blue':
      root.style.setProperty(
        '--bg-gradient',
        'radial-gradient(circle at 50% 20%, #001f3f 0%, #001122 80%)',
      )
    ...
    case 'red':
      root.style.setProperty(
        '--bg-gradient',
        'radial-gradient(circle at 50% 20%, #220000 0%, #000000 90%)',
      )
    ...
    case 'yellow':
      root.style.setProperty(
        '--bg-gradient',
        'radial-gradient(circle at 50% 20%, #332900 0%, #000000 90%)',
      )
    ...
    default:
      root.style.setProperty(
        '--bg-gradient',
        'radial-gradient(circle at 50% 20%, #001a24 0%, #000a10 60%, #000000 100%)',
      )
